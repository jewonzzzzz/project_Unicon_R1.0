    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', '/resources/new_assets/img/logos/logo-inner.png');
                logodefault.attr('src', '/resources/new_assets/img/logos/logo.png');
                logowhite.attr('src', '/resources/new_assets/img/logos/logo-white.png');
                logowhitedark.attr('src', '/resources/new_assets/img/logos/logo-white.png');
                logo2.attr('src', '/resources/new_assets/img/logos/logo-2-light.png');
                logo3.attr('src', '/resources/new_assets/img/logos/logo-2-dark.png');
                logo4.attr('src', '/resources/new_assets/img/logos/logo-5-dark.png');
                logo5.attr('src', '/resources/new_assets/img/logos/logo-3-light.png');
                logo6.attr('src', '/resources/new_assets/img/logos/logo-4-light.png');
                logo7.attr('src', '/resources/new_assets/img/logos/logo-6-dark.png');
            } 
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logoinner.attr('src', '/resources/new_assets/img/logos/logo.png');
                logodefault.attr('src', '/resources/new_assets/img/logos/logo.png');
                logowhite.attr('src', '/resources/new_assets/img/logos/logo-white.png');
                logowhitedark.attr('src', '/resources/new_assets/img/logos/logo-dark.png');
                logo2.attr('src', '/resources/new_assets/img/logos/logo-2-dark.png');
                logo3.attr('src', '/resources/new_assets/img/logos/logo-2-dark.png');
                logo4.attr('src', '/resources/new_assets/img/logos/logo-5-dark.png');
                logo5.attr('src', '/resources/new_assets/img/logos/logo-3-dark.png');
                logo6.attr('src', '/resources/new_assets/img/logos/logo-4-dark.png');
                logo7.attr('src', '/resources/new_assets/img/logos/logo-6-dark.png');
            }
        });
